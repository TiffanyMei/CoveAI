...
class Company(BaseModel):
    ...
    funding_stage: Union[str, None] = Field(..., description="The funding stage that this company is currently in, converted to all lower case. None if not found.")
    valuation: Union[int, None] = Field(..., description="The approximate valuation of this company in USD, converted into an integer. None if cannot be approximated.")
